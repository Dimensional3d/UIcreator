import{i as e}from"../node_modules/@lit/reactive-element/css-tag.js";import{b as t}from"../node_modules/lit-html/lit-html.js";import{i as n}from"../node_modules/lit-element/lit-element.js";import"../node_modules/lit/index.js";import{t as r}from"../node_modules/@lit/reactive-element/decorators/custom-element.js";import{n as i}from"../node_modules/@lit/reactive-element/decorators/property.js";import"../node_modules/lit/decorators.js";import{__decorate as a}from"../_virtual/_@oxc-project_runtime@0.120.0/helpers/decorate.js";import"./canvas-image.js";var o=class extends n{constructor(...e){super(...e),this.selected=!1}emitToolDragState(e){this.dispatchEvent(new CustomEvent(`tool-drag-state`,{bubbles:!0,composed:!0,detail:{tool:`image`,active:e}}))}handleDragStart(e){e.dataTransfer?.setData(`application/x-ui-tool`,`image`),e.dataTransfer?.setData(`text/plain`,`image`),e.dataTransfer&&(e.dataTransfer.effectAllowed=`copy`),this.emitToolDragState(!0)}handleDragEnd(){this.emitToolDragState(!1)}handlePreviewRequest(){this.dispatchEvent(new CustomEvent(`preview-tool`,{bubbles:!0,composed:!0,detail:{tool:`image`}}))}static{this.styles=e`
    :host {
      display: block;
    }
  ...
  `}render(){return t`
    ...
    `}};a([i({type:Boolean})],o.prototype,`selected`,void 0),o=a([r(`tool-image`)],o);