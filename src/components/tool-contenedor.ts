...
@customElement('tool-contenedor')
export class ToolContenedor extends LitElement {
  ...
  private handleDragStart(event: DragEvent) {
    event.dataTransfer?.setData('application/x-ui-tool', 'contenedor');
    event.dataTransfer?.setData('text/plain', 'contenedor');
